...
export function Hero() {
  ...
  return (
    <section className="relative h-[100svh] min-h-[700px] w-full overflow-hidden">
      ...
      {/* content */}
      <div
        className="relative z-10 mx-auto flex h-full w-full flex-col items-center justify-center px-[6%] pb-20 text-center md:px-[8%]"
      ...
      >
        ...
        >
          <p
            className="animate-fade-up inline-flex items-center gap-3 rounded-full glass px-5 py-2 text-[11px] font-medium uppercase tracking-[0.35em] text-gold"
            style={{ animationDelay: "0.1s", marginBottom: "32px" }}
          >
          ...
          <h1
            className="animate-fade-up font-display font-semibold tracking-[0.005em] [text-shadow:0_4px_30px_rgba(0,0,0,0.6)]"
            style={{
          ...
          <p
            className="animate-fade-up text-sm leading-[1.8] text-foreground/75 md:text-base [text-wrap:balance]"
            style={{ animationDelay: "0.45s", maxWidth: "520px" }}
          >
